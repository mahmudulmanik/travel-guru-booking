        ...
        <Navbar className='our_menu' expand="lg">
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <FormControl type="text" placeholder="Search" className="header_input" />
                    </Form>
                    <Nav className="ml-auto">
                       ...
                       <h6 style={{lineHeight:'40px',marginLeft:'5px', color:'#ffffff'}}>{!loggedInUser.emails ? '' : `${loggedInUser.name}` }</h6>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
