        ...
        <div className="banner_area">
            ...
            <Form className='log_form' onSubmit={handleSubmit}>
               ...
               <div className='text-center text-light span_link'>
                   {user ? 
                       <span>Already have an account? <button className='btn btn-outline-warning' onClick={() =>setUser(!user)}> Log in </button> </span> : <span>Don’t have an account? <button className='btn btn-outline-warning' onClick={() => setUser(!user)}> Create an account</button> </span>
                   }
               </div>
            </Form>
